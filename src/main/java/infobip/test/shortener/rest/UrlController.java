...
public class UrlController {
    ...
    public DeferredResult<ResponseEntity> register(User user, @RequestBody UrlData data, HttpRequest request){
        ...
        UrlResponseBuilder responseBuilder = UrlResponseBuilder.create(request);
    ...
    private static class UrlResponseBuilder implements Func1<String, ResponseEntity> {
        ...
        public static UrlResponseBuilder create(HttpRequest request){
            return new UrlResponseBuilder(UriComponentsBuilder.fromHttpRequest(request));
        }

        private UrlResponseBuilder(UriComponentsBuilder urlBuilder) {
